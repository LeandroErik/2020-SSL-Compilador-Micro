...
//Estructura llamada REG_EXPRESION con tres campos,tipo token,tipo char y tipo int.Este es el registro para las expresiones con una longitud maxima de 32 caracteres
typedef struct{
	TOKEN clase;
	char nombre[TAMLEX];
	int valor;
